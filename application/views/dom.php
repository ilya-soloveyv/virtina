...
<ul id="myMenu" class="black">
    <li data-section="dom1"><a href="#dom1"><span class="line"></span><span class="number">01</span><span class="title">Обзор</span></a></li>
...
<div id="fp">
    <div class="move">
        <section id="dom1" class="section dom1">
            <div class="day">
        ...
        <section id="dom2" class="section dom2">
            <h2>О доме</h2>
            <div class="data">
                <div class="l">
                    <img
        ...
        <section id="dom3" class="section dom3">
            <h2>Экстерьер</h2>
        ...
        <section id="dom4" class="section dom4">
            <h2>Виды</h2>
            <div class="data color<?php echo $color[0]->iColorID; ?>">
                <ul class="color">
                    <?php
        ...
        <section id="dom5" class="section dom5">
            <h2>Детали</h2>
            <ul class="line">
                <li></li>
                <li></li>
        ...
        <section id="dom6" class="section dom6">
            <h2>Интерьер</h2>
            <ul class="line">
                <li></li>
                <li></li>
        ...
        <section id="dom7" class="section dom7">
            <h2>Планировка</h2>
            <div class="data">
                <div class="slider">
                    <div class="owl-carousel">
        ...
        <section id="dom8" class="section dom8 section_black_footer">
