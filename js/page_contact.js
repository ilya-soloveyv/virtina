...
function initMap() {
    ...
    var map = new google.maps.Map(document.getElementById('map'), {
      center: {lat: 55.7755, lng: 37.6787144},
      zoom: 16,
      styles: [
		  {
...
//   flightPath.setMap(map);
    ...
    var image = '/images/contact/Placeholder_dark_grey.png';
    ...
    var image = '/images/contact/Parking_green.png';
    var beachMarker = new google.maps.Marker({
    ...
    var image = '/images/contact/Underground_grey.png';
    var beachMarker = new google.maps.Marker({
